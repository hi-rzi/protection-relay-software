...
with outer_analysis:
    ...
    with tab_graphs:
        ...
        st.plotly_chart(fig, use_container_width=True, key="overall_graphs_tab_live_fig")
        ...
        st.plotly_chart(sweep_fig, use_container_width=True, key="overall_graphs_tab_sweep_fig")
