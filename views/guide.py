...
4. **Work through "Analysis & Tools" in order** — the tabs are always in this sequence:
   ...
   - **Fault Current Analysis** *(where this equipment has one)* — checks the CTs against a real fault current: a CT saturation check, the actual asymmetrical current waveform, and a step-by-step fault-clearing simulation.
