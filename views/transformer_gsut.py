...
with outer_analysis:
    ...
    with tab3:
        ...
        st.markdown("---")
        render_historian_overlay(st, "gsut", reference_lines=[
    ...
    with tab_fault:
        ...
        fault_scenario = st.radio(
            "Fault Scenario",
            ["Internal Fault (within 87GT zone)", "External Through-Fault"],
            ...
            help=(
                ...
                "healthy 87GT should NOT operate — it's outside this differential zone's job to "
                "clear it."
            ),
        )
        ...
        if run_sim:
            if sim_eval["is_trip"]:
                ...
                if fault_scenario.startswith("External"):
                    sim_caption_ph.info("🛡️ Relay checks the fault — operate current stays at zero. 87GT correctly stays SECURE; clearing this through-fault is outside its zone.")
                else:
