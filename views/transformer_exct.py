...
from common.ui_helpers import slider_with_exact_input, MR_CT_TAPS_600_5, fault_term_info, card_section_nav, equipment_switcher
...
selected, c, pinned = card_section_nav(sections, key_prefix="exct", pin_first=True)
